...
uint256 hashGenesisBlock("0x4faba6fdfb0e4eba132401d6836ed7af72823cfb58512c238713364ed9630f71");
...
const string strMessageMagic = "SilverDollars Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 60; // SilverDollars: 60 min.
static const int64 nTargetSpacing = 120; // SilverDollars: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal silverdollars miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SilverDollars", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0e77a3b7f48baf061660d960548515c23c57455424aa18ce497f66ee42f41f24");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Calgary Metro 12/06/2013 Calgary student in running for travel competition that would pay tuition";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1371087838; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 218950;

        if (fTestNet)
        {
            block.nTime    = 1371077688;
            block.nNonce   = 1573057;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbacfc9eae7a056de4b781a914c7a09a0132badb5f476288c063b3275476c2ef0"));
